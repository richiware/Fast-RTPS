...
inline StatefulReader* create_statefulreader_from_implementation(std::shared_ptr<RTPSReader::impl>& impl)
{
    assert(dynamic_cast<StatefulReader::impl*>(impl.get()) != nullptr);
    return new StatefulReader(impl);
}
