...
#ifndef __RTPS_READER_WRITERPROXY_H__
#define __RTPS_READER_WRITERPROXY_H__
...
class WriterProxy
{
    ...
    public:
         ...
         */
        WriterProxy(StatefulReader::impl& reader, const RemoteWriterAttributes& watt);
...
#endif
#endif /* __RTPS_READER_WRITERPROXY_H__*/
