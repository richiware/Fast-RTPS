...
#ifndef __RTPS_BUILTIN_LIVELINESS_TIMEDEVENT_WLIVELINESSPERIODICASSERTION_H__
#define __RTPS_BUILTIN_LIVELINESS_TIMEDEVENT_WLIVELINESSPERIODICASSERTION_H__
...
class WLivelinessPeriodicAssertion : public TimedEvent
{
    public:
         ...
         */
        WLivelinessPeriodicAssertion(WLP& wlp, LivelinessQosPolicyKind kind);
...
#endif
#endif //__RTPS_BUILTIN_LIVELINESS_TIMEDEVENT_WLIVELINESSPERIODICASSERTION_H__
